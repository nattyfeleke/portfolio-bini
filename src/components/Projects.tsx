...
const projects = [
  ...
  {
    id: 5,
    title: "Time Software Technology corporate website",
    description:
      "A corporate website for a technology company based in Ethiopia.",
    category: "Mobile App",
    size: "large",
    link: "https://timesoftwareplc.com/",
    image: "https://timesoftwareplc.com/images/Logo_large.png",
  },
];
            ...
            >
              {project.size === "large" ? (
                <a
                  ...
                  className="group relative block rounded-3xl overflow-hidden bg-surface border border-white/5 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-accent/10 md:col-span-12 aspect-[16/9] md:aspect-[21/9] h-full  "
                  style={{ cursor: "none" }}
                >
                  ...
                  <div className="absolute inset-0 p-8 flex flex-col justify-end bg-gradient-to-t from-base/90 via-base/40 to-transparent">
                    <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                      <span className="inline-block px-3 py-1 text-xs rounded-full bg-white/10 backdrop-blur-md font-medium text-primary/90 mb-4 border border-white/10">
                        {project.category}
                      </span>
                      <h3 className="text-3xl md:text-4xl font-medium text-primary mb-2 leading-tight">
                        {project.title}
                      </h3>
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label={`Open ${project.title} (opens in a new tab)`}
                  className="group relative block rounded-3xl overflow-hidden bg-surface border border-white/5 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-accent/10 md:col-span-12 aspect-[4/3] lg:aspect-[5/3]"
                  style={{ cursor: "none" }}
                >
                  <div className="absolute inset-0 bg-surface">
                    <img
                  ...
                  <div className="absolute inset-0 p-8 flex flex-col justify-end bg-gradient-to-t from-base/90 via-base/40 to-transparent">
                    <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                      <span className="inline-block px-5 py-2 text-base rounded-full bg-white/10 backdrop-blur-md font-medium text-primary/90 mb-4 border border-white/10">
                        {project.category}
                      </span>
                      <h3 className="text-3xl md:text-6xl font-medium text-primary mb-2 leading-tight">
                        {project.title}
                      </h3>
                      <p className="text-primary/70 text-base md:text-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100">
                        {project.description}
                      </p>
                    </div>
                  </div>
